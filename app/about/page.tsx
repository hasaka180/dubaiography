  ...
  return (
    <div className="shell">
      ...
      <div className={s.prose}>
        ...
        <h2>What we cover</h2>
        <p>
          Six evergreen sections, deliberately broad, plus the news.{' '}
          ...
          freehold and the mechanics of building something here. <strong>Technology</strong>{' '}
          follows the AI, fintech and startups behind the future-city branding.{' '}
